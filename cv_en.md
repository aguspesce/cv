...
: [**MANDYOC**](https://github.com/ggciag/mandyoc)
    ...
    * Community building
    (license, code of conduct, how to contribute guidelines, Readme)
...
for _[CoCo Program](https://twitter.com/CodeCommunicate/)_
...
_Secretaría de Extensión, Facultad de Ciencias Exactas, Físicas y Naturales,
...
_Revista de la Asociación Geológica Argentina 78 (2), 333-337_

    Pesce, A; Giménez, M; Bibiana, C; Gianni, G; Folguera, A

    [https://revista.geologica.org.ar/raga/article/view/246](https://revista.geologica.org.ar/raga/article/view/246)
...
_Opening and Closure of the Neuquén Basin in the Southern Andes, Springer_
    ...
    Gianni, G; Pesce, A; García, H. P. A; Lupari, M; Correa-Otto, S; Nacif, S;
    Folguera, A
...
WebDev
: CSS, Bootstrap, Milligram, Normalize
